...
\begin{exer}
	...
	\hnote{Ayuda: asuma que el enrutamiento es óptimo y que los enrutadores pueden dividir la carga del tráfico en varias interfaces.}
...
\begin{exer}
	...
	\begin{enumerate}
		...
		\item En el encabezado de TCP vimos que además de un campo de confirmación de 32 bits hay
		      un bit \cd{ACK}. ¿Este campo agrega realmente algo? ¿Por qué o por qué no?
	\end{enumerate}
\end{exer}
